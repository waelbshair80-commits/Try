...
# Bot configuration
BOT_TOKEN = os.getenv("BOT_TOKEN", "8147738548:AAEB_GxtlBOVE3lgq_Lb5PyvUMdej06kCOA")
ADMIN_GROUP_ID = os.getenv("ADMIN_GROUP_ID", "-4975872530")
...
# All function definitions (load_json_file, save_json_file, etc.) stay unchanged
...
def install_requirements():
    """
    Checks for and installs dependencies from requirements.txt at bot startup.
    """
    ...
    if os.path.exists(requirements_file):
        ...
        try:
            ...
            print("Please ensure you have pip installed and the dependencies are correctly formatted.")
...
def main():
    """Start the bot"""
    # Install dependencies from requirements.txt before starting the bot
